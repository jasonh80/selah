...

{
  ...
  "sections": [
    ...
    { "id": "discipleship", "title": "Disciple It", "type": "discipleship", "priority": 8, "isCore": true, "cardSummary": "<short>", "fullContent": "<Write one concise Disciple It section drawn only from this chapter. First show how the chapter invites someone to FOLLOW Jesus; then offer an entirely optional way its truth could help another person follow Him too. Write INVITATIONS, NEVER ASSIGNMENTS. Do not command the reader to contact, teach, share with, recruit, or report to anyone. No quotas, deadlines, guilt, program pitch, or spiritual score. Keep Jesus and the gospel central, distinguish this from Live It, and support it with chapter verse references. GOOD (invitation): 'If it would help, you might invite a friend to notice how Jesus answers the trap in verses 15-17 — and let that be all.' PROHIBITED (assignment): 'Ask three people this week to read Mark 12 and report back.'>", "verseRefs": ["<this chapter, e.g. c:v or c:v-v>"] },
