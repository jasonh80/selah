...
// 2500 (Codex recommendation, owner-relayed 2026-07-21): room for accuracy,
// composition, and exclusions blocks without crowding — deliberately not
// unlimited. The ceiling is not a target; past ~200 words image models drop
// competing directives. Selection still wins.
export const IMAGE_REDO_NOTES_MAX_CHARS = 2500;
