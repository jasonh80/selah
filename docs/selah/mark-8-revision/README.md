# Mega Mark 8 — review artifact

Same lane as Mark 7 (`revision-previews.ts` + `verify:mega-revisions`).

| Piece | Where |
| --- | --- |
| Base snapshot (live render model) | `base-workup.json` (sha256 `a97cb1f1fd9bcb3c3f765f40536f333d6920df795b6862b7385decb5a2783c77`) |
| Proposed revision | `lib/ai/fixtures/mark-8-mega-revision.json` |
| Diff | `diff.md` |
